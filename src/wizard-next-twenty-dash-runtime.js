...
export const SPIKE_TRACK_SOURCE_ERUPTION_INTERVAL=.055;
export const SPIKE_TRACK_ERUPTION_TIME_MULTIPLIER=5;
export const SPIKE_TRACK_SPEC=Object.freeze({id:'SPIKE-TRACK',element:'Earth',cooldown:5,damage:30,knockback:10,pathRadius:.82,spikeSpacing:.85,eruptionInterval:SPIKE_TRACK_SOURCE_ERUPTION_INTERVAL*SPIKE_TRACK_ERUPTION_TIME_MULTIPLIER});
export const TOXIC_TRAP_SOURCE_DURATION=3.2;
export const TOXIC_TRAP_DURATION_MULTIPLIER=5;
export const TOXIC_TRAP_SPEC=Object.freeze({id:'TOXIC-TRAP',element:'Earth',cooldown:6,seedDelay:.18,duration:TOXIC_TRAP_SOURCE_DURATION*TOXIC_TRAP_DURATION_MULTIPLIER,radius:2.05,poisonDamage:5,poisonTicks:5,poisonInterval:.72});
export const SNARE_TRACK_SOURCE_ENTANGLE_DURATION=1.35;
export const SNARE_TRACK_ENTANGLE_DURATION_MULTIPLIER=5;
export const SNARE_TRACK_SPEC=Object.freeze({id:'SNARE-TRACK',element:'Earth',cooldown:6,count:3,damage:20,speed:10.5,range:8.5,radius:.40,laneAngles:Object.freeze([0,-.26,.26]),entangleDuration:SNARE_TRACK_SOURCE_ENTANGLE_DURATION*SNARE_TRACK_ENTANGLE_DURATION_MULTIPLIER});
