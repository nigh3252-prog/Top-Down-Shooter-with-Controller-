...
function addStyles(){
  ...
  .rewardChoice{position:relative}.rewardClassBadge{position:absolute;top:7px;right:7px;min-width:42px;height:24px;padding:0 8px;border-radius:999px;display:grid;place-items:center;border:1px solid rgba(159,210,201,.55);background:rgba(8,24,25,.9);color:#d9eee9;font-size:10px;font-weight:900;letter-spacing:0;white-space:nowrap}
