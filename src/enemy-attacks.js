export const ENEMY_ATTACKS = {
  ...
  armoredMaceCrush: { id:'armoredMaceCrush', name:'Armored Crush', kind:'melee', range:2.0, tokenCost:1.55, windup:.72, active:.20, recovery:.62, cooldown:1.7, damage:15, arc:.72, knock:.6, wantsSolo:true }
};
...
export const ENEMY_ATTACK_BY_KIND = {
  ...
  armoredMaceGoblin: ENEMY_ATTACKS.armoredMaceCrush
};
