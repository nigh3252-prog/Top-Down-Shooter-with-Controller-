Warning: truncated output (original token count: 35343)
Total output lines: 2593
...
function spawnHitEffect(point, type, damage){
  ...
  sp.scale.set(3.4,1.7,1).multiplyScalar(.75 + clamp(damage/28, .4, 2) * .45);   // big hits read b…5343 tokens truncated…'Enter fullscreen';
