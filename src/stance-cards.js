...
export const STANCE_CARDS = [
  ...
  {
    id:'S11',
    name:'S11 Saber Waltz',
    chain:['horizontal6','horizontal4','horizontal5'],
    preferredWeapons:['saber'],
    styleTags:['saber','horizontal','slice','duelist']
  },
  {
    id:'S12',
    name:'S12 Crescent Cut',
    chain:['vertical5','horizontal','horizontal2'],
    preferredWeapons:['saber','longsword'],
  ...
  },
  {
    ...
    preferredWeapons:['saber'],
    styleTags:['saber','horizontal','slice','flashy']
  },
  {
    id:'S14',
    name:'S14 Street Duelist',
    chain:['stab','horizontal6','horizontal2'],
    preferredWeapons:['saber','dagger'],
  ...
  },
  {
    ...
    preferredWeapons:['longsword','saber'],
