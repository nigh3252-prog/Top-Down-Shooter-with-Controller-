...
const ARCANA_HANDLER_ROWS = Object.freeze([
  ...
  ['BLADED-VINE','wizardVfxArcana'],
  ['STONE-SHOT','wizardNextSource'],
  ['SPARK-CONTACT','wizardVfxArcana'],
  ...
  ['GUST-BURST','wizardVfxArcana'],
  ['RAZOR-BURST','wizardVfxArcana'],
  ['SPIKE-TRACK','wizardNextTwentyDash'],
  ['TOXIC-TRAP','wizardNextTwentyDash'],
  ['SNARE-TRACK','wizardNextTwentyDash'],
  ['THUNDER-LINE','wizardVfxArcana'],
  ['CIRCUIT-LINE','wizardVfxArcana'],
  ...
  ['BLAZING-LARIAT','wizardVfxArcana'],
  ['EXPLOSIVE-CHARGE','wizardVfxArcana'],
  ...
  ['STORM-DRAFT','wizardVfxArcana'],
  ['BLURRING-FALCONRY','wizardVfxArcana'],
  ['WHIRLING-WIND-AGENT','wizardVfxArcana'],
  ['KNOCKOUT-BOULDER','wizardVfxArcana'],
  ['TOXIC-BOLAS','wizardVfxArcana'],
  ['ROCK-N-ROLL','wizardVfxArcana'],
  ['EARTH-STOMP-AGENT','wizardVfxArcana'],
  ...
  ['BUBBLE-BARRAGE','wizardVfxArcana'],
]);
