...
const revisionHistory=new Map([
  ...
  ['Dragon Arc','The first version was one projectile following a sinusoidal world path. Source-first review established passive eight-charge stock, 0.6-second recovery, one piercing 8-damage dragon per spent charge, and live aim sampled throughout release; the prototype was replaced with that stock-fed stream. A second frame-by-frame visual pass then replaced the interim bead-chain carrier with broad open-jawed dragon silhouettes, layered yellow-to-orange flame bodies, independent flicker, muzzle flares, embers, and white-hot piercing impacts. A rendered phone capture exposed additive color blowout, pale ground-ring artifacts, and excessive stream overlap, so the next pass switched the carrier to normal-blended dark-red/orange/gold layers, removed the rings, and shortened launch flashes. Finally, an automated side-view Enemy Lab cast exposed a remaining narrow fire-arrow silhouette; the current pass rebuilt the head and separated jaws, widened and shortened the flame body, and increased center spacing to about 3.3 world units while retaining a rapid roughly 1.4-second full-stock stream.'],
