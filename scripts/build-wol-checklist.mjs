...
const revisionHistory=new Map([
  ...
  ['Dragon Arc','The first version was one projectile following a sinusoidal world path. Source-first review established passive eight-charge stock, 0.6-second recovery, one piercing 8-damage dragon per spent charge, and live aim sampled throughout release; the prototype was replaced with that stock-fed stream. A second frame-by-frame visual pass then replaced the interim bead-chain carrier with broad open-jawed dragon silhouettes, layered yellow-to-orange flame bodies, independent flicker, muzzle flares, embers, and white-hot piercing impacts. A rendered phone capture exposed additive color blowout, pale ground-ring artifacts, and excessive stream overlap; the next pass changed the main carrier to normal-blended dark-red/orange/gold layers, removed the rings, shortened launch flashes, and matched the source release to roughly one second.'],
