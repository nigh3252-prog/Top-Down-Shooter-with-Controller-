...
insertAfterOnce('src/stance-compatibility.js',
...
replaceOnce('src/stance-compatibility.js',
...
replaceOnce('src/weapons.js',`  katana: {\n    label: 'Katana',\n    weightClass: 'Medium',\n    staminaClass: 'Medium',`,`  katana: {\n    label: 'Katana',\n    weightClass: 'Light',\n    staminaClass: 'Light',`,'Katana class');
replaceOnce('src/weapons.js',`  claymore: {\n    label: 'Claymore',\n    weightClass: 'Heavy',\n    staminaClass: 'Heavy',`,`  claymore: {\n    label: 'Claymore',\n    weightClass: 'Medium',\n    staminaClass: 'Medium',`,'Claymore class');

replaceOnce('src/stance-deck.js',`import { STANCE_CARDS } from './stance-cards.js';`,`import { STANCE_CARDS } from './stance-cards.js';\nimport { getStanceClass, getStanceClassPresentation } from './stance-compatibility.js';`,'stance-deck presentation import');
replaceOnce('src/stance-deck.js',
...
replaceOnce('src/stance-deck.js',
  ...
  'hand-card stance frame');

replaceOnce('src/run-draft.js',`import { STANCE_CARDS } from './stance-cards.js';`,`import { STANCE_CARDS } from './stance-cards.js';\nimport { getStanceClass, getStanceClassPresentation } from './stance-compatibility.js';`,'run-draft presentation import');
replaceOnce('src/run-draft.js',
  ...
  'reward badge style');
replaceBetween('src/run-draft.js',
  ...
  'three-card reward selector');

replaceOnce('src/enemy-lab-stance-compatibility.js',`  resolveStanceWeaponCompatibility,\n  stanceClassCounts,`,`  resolveStanceWeaponCompatibility,\n  stanceClassCounts,\n  stanceClassDisplayName,`,'Enemy Lab presentation import');
replaceOnce('src/enemy-lab-stance-compatibility.js',`sub:'Weight-class compatibility'`,`sub:'Speed / Balanced / Power compatibility'`,'Enemy Lab category copy');
replaceOnce('src/enemy-lab-stance-compatibility.js',
...
replaceOnce('src/enemy-lab-stance-compatibility.js',
  ...
  'Enemy Lab group title');

replaceOnce('tests/stance-compatibility.test.mjs',`import assert from 'node:assert/strict';`,`import assert from 'node:assert/strict';\nimport { readFileSync } from 'node:fs';\nimport { STONE_WEAPONS } from '../src/weapons.js';`,'compat test imports');
replaceOnce('tests/stance-compatibility.test.mjs',`  getStanceClass,\n  getWeaponClass,`,`  getStanceClass,\n  getStanceClassPresentation,\n  getWeaponClass,\n  normalizeStanceClass,\n  stanceClassDisplayName,`,'compat presentation imports');
insertAfterOnce('tests/stance-compatibility.test.mjs',`assert.deepEqual(STANCE_CLASSES,['Light','Medium','Heavy']);`,
  ...
  'presentation tests');
insertAfterOnce('tests/stance-compatibility.test.mjs',`assert.equal(resolveStanceWeaponCompatibility({stance:{id:'missing'},weapon:dagger}).tier,'unknown');`,
  ...
  'UI source tests');
replaceOnce('tests/combat-pass.test.mjs',
  ...
  'weapon class test table');
replaceOnce('tests/stance-class-template-rollout.test.mjs',
  ...
  'rollout Katana/Claymore expectations');

const classDoc='docs/design/STANCE_2_CLASS_TEMPLATE.md',doc=read(classDoc);
